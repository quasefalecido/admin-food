...
@section('content_header')
  ...
  <h1>Permissões <a href="{{ route('permissions.create') }}" class="btn btn-dark">
          ...
          @foreach ($permissions as $permission)
            <tr>
              ...
              <td style="width=10px;">
                ...
                <a href="{{ route('permissions.show', $permission->id) }}" class="btn btn-warning">
                  <i class="fas fa-eye"></i>
                </a>
                <a href="{{ route('permissions.profiles', $permission->id) }}" class="btn btn-primary">
